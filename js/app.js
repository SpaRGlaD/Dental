(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".recall__slider")) new core(".recall__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
        ...
        if (document.querySelector(".doctors__slider")) {
            const thumbsSwiper = new core(".doctors__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 6,
        ...
        if (document.querySelector(".quiz__content")) new core(".quiz-slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
